...
pad_x = pad_x.reshape(14,5,1) # 들어갈땐 3차원이기에 리쉐이프 해주어야한다 
...
model.add(Conv1D(15, 2, input_shape=(5,1)))
model.add(LSTM(32, input_shape=(5,1)))                # output dim 은 y의 갯수 input length 는 다시 
