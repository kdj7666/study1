...
np.save('d:/study_data/_save/_npy/keras49_8_train_x(horse-or-human).npy', arr =x_train)
np.save('d:/study_data/_save/_npy/keras49_8_train_y(horse-or-human).npy', arr =y_train)
np.save('d:/study_data/_save/_npy/keras49_8_test_x(horse-or-human).npy', arr =x_test)
np.save('d:/study_data/_save/_npy/keras49_8_test_y(horse-or-human).npy', arr =y_test)
