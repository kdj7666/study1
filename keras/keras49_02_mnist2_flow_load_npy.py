...
# np.save('d:/study_data/_save/_npy/keras49_2_train_x(mnist).npy', arr=x_train)
# np.save('d:/study_data/_save/_npy/keras49_2_train_y(mnist).npy', arr=y_train)
# np.save('d:/study_data/_save/_npy/keras49_2_test_x(mnist).npy', arr=x_test)
# np.save('d:/study_data/_save/_npy/keras49_2_test_y(mnist).npy', arr=y_test)
# # 넌파이 파일로 저장한다 넌파일수치로 저장이 됨

# x_train = np.load('d:/study_data/_save/_npy/keras49_2_train_x(mnist).npy')
# y_train = np.load('d:/study_data/_save/_npy/keras49_2_train_y(mnist).npy')
# x_test = np.load('d:/study_data/_save/_npy/keras49_2_test_x(mnist).npy')
# y_test = np.load('d:/study_data/_save/_npy/keras49_2_test_y(mnist).npy')
...
# loss :  0.41142740845680237
# val_loss :  1.5626977682113647
# val_accuracy :  0.19552980363368988
# accuracy :  0.20380795001983643
# 걸린시간 :  34.65043115615845


# loss :  14.458634376525879
# val_loss :  11.951998710632324
# val_accuracy :  0.10562913864850998
# accuracy :  0.1130426749587059
# 걸린시간 :  21.70417356491089


# loss :  1.0912314653396606
# val_loss :  1.2919578552246094
# val_accuracy :  0.16030661761760712
# accuracy :  0.14854931831359863
# 걸린시간 :  34.36933135986328
