...
# 1. 데이터
x_train = np.load('d:/study_data/_save/_npy/keras49_6_train_x(cat_dog).npy')
y_train = np.load('d:/study_data/_save/_npy/keras49_6_train_y(cat_dog).npy')
x_test = np.load('d:/study_data/_save/_npy/keras49_6_test_x(cat_dog).npy')
y_test = np.load('d:/study_data/_save/_npy/keras49_6_test_y(cat_dog).npy')
