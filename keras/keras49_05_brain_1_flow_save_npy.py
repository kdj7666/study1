...
x_train = xy_train[0][0]  # x
y_train = xy_train[0][1]  # y
x_test = xy_test[0][0]  # x
y_test = xy_test[0][1]  # y
...
np.save('d:/study_data/_save/_npy/keras49_5_train_x(brain).npy', arr =x_train)
np.save('d:/study_data/_save/_npy/keras49_5_train_y(brain).npy', arr =y_train)
np.save('d:/study_data/_save/_npy/keras49_5_test_x(brain).npy', arr =x_test)
np.save('d:/study_data/_save/_npy/keras49_5_test_y(brain).npy', arr =y_test)
