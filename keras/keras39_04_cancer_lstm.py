...
# activation 활성화 함수 이것으로 인해 결과값이 엄청좋아지고 안좋아진다 필수 ( 다시 공부할것 시그모이드 포함 )
#  레이어를 한정시키며 펑 터지는것을 방지한다 ( 찾아볼것 )
# linear 선형  
# sigmoid = 0과 1이 아니고 0에서 1으로 한정 시킨다 ( 어떤값을 넣어도 0과 1사이로 표출이 된다 ) 반올림으로 0과 1로 
...
# r2.score : 0.6112531969309463
# 걸린시간 :  51.602243423461914