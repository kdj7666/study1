...
# 1. 데이터
x_train = np.load('d:/study_data/_save/_npy/keras49_7_train_x(rps).npy')
y_train = np.load('d:/study_data/_save/_npy/keras49_7_train_y(rps).npy')
x_test = np.load('d:/study_data/_save/_npy/keras49_7_test_x(rps).npy')
y_test = np.load('d:/study_data/_save/_npy/keras49_7_test_y(rps).npy')
