...
model.save('./_save/k23_smm_cancer.h5')
...
mcp = ModelCheckpoint(monitor='val_loss', node='auto', verbose=1,
                      save_best_only=True,
                      filepath= "".join([filepath, 'k24_cancer', date, '_', filename]))
             
a = model.fit(x_train, y_train, epochs=300, batch_size=100,
          validation_split=0.2,
          callbacks = [earlystopping, mcp],    # 이것도 리스트 형식이라는것 더 넣을수있음 
...
# RobustScaler
# loss :  [0.14155369997024536, 0.9473684430122375, 0.03764219582080841]
# acc.score :  0.9473684210526315
# 걸린시간 :  6.082792043685913


# MaxAbsScaler 2회 
# loss :  [0.1500890702009201, 0.9473684430122375, 0.046168312430381775]
# acc.score :  0.9473684210526315
# 걸린시간 :  14.349456071853638

# acc.score :  0.9298245614035088
# 걸린시간 :  13.999714851379395

# 함수형 모델 
# acc.score :  0.6140350877192983
# 걸린시간 :  16.214675664901733
