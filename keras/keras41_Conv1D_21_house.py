...
from tensorflow.python.keras.layers import Dense, Dropout, Input, Conv2D, Flatten, Conv1D
...
print(x_train.shape, x_test.shape) # (1070, 12) (268, 12)
print(y_train.shape, y_test.shape) # (1070,) (268,)
...
x_train = x_train.values.reshape(1070,12,1) # values  <- pandas 에서 불러오기  
x_test = x_test.reshape(268,12,1)
...
model = Sequential()
model.add(Conv1D(32, 2, padding='same', input_shape=(12,1)))
model.add(Flatten())
...
# drop1 = Dropout(0.12)(dense1)
# dense2 = Dense(5, activation='relu')(drop1)
# dense3 = Dense(3, activation='relu')(dense2)
# output1 = Dense(1)(dense3)
# model = Model(inputs=input1, outputs=output1)

# model.save('./_save/k23_smm_house.h5')
...
a = model.fit(x_train, y_train, epochs=300, batch_size=50,
...
# 함수형 모델 
# loss :  1548992384.0
# RMSE :  39357.239970521274
# r2스코어 :  0.7126596413211777
# 걸린시간 :  31.436527729034424

# loss :  35290046464.0
# RMSE :  187856.45729663208
# r2스코어 :  -6.8446533207896
# 걸린시간 :  16.6484534740448
