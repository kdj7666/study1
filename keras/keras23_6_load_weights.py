...
# model.save_weights('./_save/keras23_5_save_weigths1.h5')

# model = load_model('./_save/keras23_5_save_model.h5')

model.load_weights('./_save/keras23_5_save_weigths1.h5')

model.load_weights('./_save/keras23_5_save_weigths2.h5')
...
# model.save('./_save/keras23_3_save_model.h5') # . 작업경로 / _save 밑에 / 만들겟다 이 파일을 ( model. save 모델만 세이브 )

# model.save_weights('./_save/keras23_5_save_weigths2.h5')
