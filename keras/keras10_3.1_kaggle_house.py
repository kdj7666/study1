...
input_labels = pd.read_csv(path + 'train.csv',
                             index_col=0)

input_labels = pd.read_csv(path + 'test.csv',
                             index_col=0)
...
train_labels = input_labels = pd.read_csv(path + 'train.csv',
                             index_col=0)

test_labels = input_labels = pd.read_csv(path + 'test.csv',
                             index_col=0)
