...
print(xy_train[0][0].shape, xy_train[0][1].shape)  # (10, 200, 200, 1) (10, 2)
...
hist = model.fit_generator(xy_train, epochs=120, steps_per_epoch=32,    
...
# val_accuracy :  0.5
# accuracy :  0.5
# 걸린시간 :  33.51839780807495



# loss :  0.6941454410552979
# val_loss :  0.6986305713653564
# val_accuracy :  0.41999998688697815
# accuracy :  0.5
# 걸린시간 :  33.30748248100281
