...
#2. 모델구성
model = Sequential()
model.add(Dense(40, input_dim=8, activation='linear')) #sigmoid : 이진분류일때 아웃풋에 activation = 'sigmoid' 라고 넣어줘서 아웃풋 값 범위를 0에서 1로 제한해줌
model.add(Dense(30, activation='sigmoid'))               # 출력이 0 or 1으로 나와야되기 때문, 그리고 최종으로 나온 값에 반올림을 해주면 0 or 1 완성
model.add(Dense(30, activation='relu'))               # relu : 히든에서만 쓸수있음, 요즘에 성능 젤좋음
...
# loss :  [0.39313188195228577, 0.8320895433425903]
# acc스코어 :  0.832089552238806
