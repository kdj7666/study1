...
model.fit(x_train, y_train, epochs=1500,
          batch_size=320,validation_split=0.2,
          callbacks=earlyStopping, verbose=1) #batch default :32
...
# loss: 0.5868 - accuracy : 0.7540
# loss :  0.5867605805397034
# acc :  0.754015972094731


# - loss: 0.5503 - accuracy: 0.7662
# loss :  0.5502926111221313
# accuracy :  0.7662012577056885
